#ESTE ARCHIVO NO SE MODIFICA NI INFLUYE EN LA EJECUCION, ES SIMPLEMENTE UNA GUIA CON COMENTARIOS. 
...
class ExpertSystem:
    ...
    #   
    #   Devuelve una tupla con la velocidad lineal y angular que se quiere dar al robot
